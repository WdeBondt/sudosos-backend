...
describe('VatGroupService', () => {
  ...
  describe('calculateVatDeclaration', async () => {
          ...
          .forEach((r) => {
            ...
            if (y === year) {
              if (vatOnly) {
                ...
                actualValues[vat.id][m] += Math.round(
                  r.amount * r.product.priceInclVat.getAmount(),
                );
              }
            }
          })));
    ...
    it('should correctly calculate full monthly earnings 2021', async () => {
      await testVatCalculations(2021, VatDeclarationPeriod.MONTHLY, false);
    });

    it('should correctly calculate full monthly earnings 2022', async () => {
      await testVatCalculations(2022, VatDeclarationPeriod.MONTHLY, false);
    });
    it('should correctly calculate full quarterly earnings 2021', async () => {
    ...
    it('should correctly calculate full quarterly earnings 2022', async () => {
      const response = await testVatCalculations(2022, VatDeclarationPeriod.QUARTERLY, false);
      await testPeriodConsistency(response, VatDeclarationPeriod.MONTHLY, false);
    });

    it('should correctly calculate full annual earnings 2021', async () => {
    ...
    it('should correctly calculate full annual earnings 2022', async () => {
